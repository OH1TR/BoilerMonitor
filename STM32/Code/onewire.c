...
#define OW_DIR_IN() gpio_set_mode(OW_PORT, GPIO_MODE_INPUT, GPIO_CNF_INPUT_FLOAT, OW_PIN);
#define OW_DIR_OUT() gpio_set_mode(OW_PORT, GPIO_MODE_OUTPUT_50_MHZ,GPIO_CNF_OUTPUT_PUSHPULL, OW_PIN);
